...
//:
//: As you move through this course, you’ll learn more ways to get things done, and different ways to use code to solve problems and build great apps. Things will start small and simple with some basics. But as your skills and knowledge grow, you'll be able to do more and more with what you know.
//:
