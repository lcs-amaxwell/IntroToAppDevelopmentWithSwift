...
In programming, there is an important difference between names that always refer to the same value, and names where the value can change over time.
 ...
 For example, think about “your favourite shirt” or other article of clothing. When you were a little kid you may have had a favourite shirt. As you got older, you outgrew it either in size or style, and now a different shirt is your favourite. In the future, you’ll probably have a different favourite shirt. You still have that name or idea of a “favourite shirt” — but the actual shirt you are referring to changes over time. In code, you'd say that `favouriteShirt` is a variable.
