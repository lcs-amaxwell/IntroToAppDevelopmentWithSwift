/*:
 ...
 App developers always work with code provided by others. In the case of BoogieBot, a number of functions are defined that make BoogieBot start, move and change colours.
