...
/*:
 ...
 The moves should all be pretty clear, except `fabulize()` and `defabulize()`. The first changes BoogieBot into fabulous new colours; the second changes BoogieBot back to a dull robot grey.
