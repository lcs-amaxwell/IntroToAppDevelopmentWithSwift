/*:
 ...
 If you can sort-of-remember the name of a method or property, you can just start typing and Xcode will offer you autocompletion suggestions. Programmers use autocompletion pop-up menu all the time. Here you can see the autocompletion suggestions for "`.has`" when used on a `String` instance:
 
 ![Autocomplete popup](Autocomplete.png)
 
 Don't worry if most of these options don't make sense to you right now. You can see `hasPrefix`, which you know about, and you can probably make a good guess at what `hasSuffix` does as well. As you enter more characters, fewer options will appear in the list. You can use the cursor keys to select an option, and the Tab key to complete it and keep on typing.
...
// Practise here by typing . after "example":
example
