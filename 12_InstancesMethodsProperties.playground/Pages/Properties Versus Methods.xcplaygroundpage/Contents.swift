...
/*:
 ...
 When you’re building an app, almost all of the code you write is in the form of instance methods or properties on types. And they’re often on types that you create. An app is made of many instances of different types, all working together.
