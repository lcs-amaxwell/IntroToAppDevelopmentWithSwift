/*:
 ...
 Different types of things have different properties and behaviours. A tennis ball is filled with air and bounces if you drop it. An egg is filled with egg white and egg yolk and breaks if you drop it.
  
 In programming, types work in much the same way.
 
 For example, you’ve already used a type called a string to work with characters and text. Strings have properties and behaviours that are tailored for that purpose.
