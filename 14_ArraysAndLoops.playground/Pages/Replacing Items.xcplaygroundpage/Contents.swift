 ...
 */
var flavours = ["Chocolate", "Vanilla", "Strawberry", "Pistachio", "Rocky Road"]

let firstFlavour = flavours[0] // Remember, the first item is at index 0
/*:
...
flavours[0] = "Fudge Ripple"

let newFirstFlavour = flavours[0]

/*:
 - experiment: Change the value of "Pistachio" to a flavour of ice cream that’s not already used in the array, like “Mint Chocolate Chip.” Check the results sidebar to make sure you’ve made the change.
*/
// Change "Pistachio" to another flavour.
