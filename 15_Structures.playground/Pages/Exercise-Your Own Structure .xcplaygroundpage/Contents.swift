/*:
 ...
 - callout(Exercise):
 Think of another real-world object and its properties. Make up some actions or behaviours that the object might be able to perform. Write them all in plain English first in a comment:
 */
