/*:
 ...
 You probably know the word console in the context of video games and TV stands. In programming, though, the console is a message centre that can show details about the way a program is running.
 ...
 Show and hide the console a few times, just to practise, but leave the console showing when you’re done.
