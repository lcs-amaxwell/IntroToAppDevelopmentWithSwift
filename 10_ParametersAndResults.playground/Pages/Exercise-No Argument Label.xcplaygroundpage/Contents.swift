/*:
 ...
 Some function names are descriptive enough that they don’t need a label for their argument. To write a function that can be called with an argument only, you use `_` where you'd normally specify the argument label.
