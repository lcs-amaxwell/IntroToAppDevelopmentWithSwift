...
//: - Experiment: Call the function a few more times with the names of your favourite celebrities. Note how autocompletion tells you about both parameters and how you can use the Tab key to move to the next argument.
...
//:
//: [Previous](@previous)  |  page 4 of 17  |  [Next: Other Favourite Things](@next)
