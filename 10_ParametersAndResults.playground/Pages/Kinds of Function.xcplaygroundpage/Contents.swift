 ...
 **✅ Parameters, ❌ Return value**\
 `paintPicture(width: Int, height: Int, dominantColour: UIColour)`
 
 These functions do work that changes depending on the arguments, but don't give anything back.
 
 Now you can ask the artist to make a painting of a certain size, perhaps using a particular colour scheme or featuring your favourite scenery. You take more control of the work performed, but the artist still has full control over the painting, and will hang it wherever they like.
 ...
 **✅ Parameters, ✅ return value**\
 `paintPicture(width: Int, height: Int, dominantColour: UIColour) -> Painting`
